...
Im Rahmen dieser Arbeit wird daher eine prototypische Lösung mithilfe der Methoden der Constraint-Programmierung, speziell jener der Satisfiability Modulo Theories (\gls{SMT}), erarbeitet, welche optimale Lösungen finden soll.
...
Während das für Probleme kleiner bis mittlerer Größe innerhalb der gewünschten zehn Minuten möglich ist, bedarf die optimale Lösung
