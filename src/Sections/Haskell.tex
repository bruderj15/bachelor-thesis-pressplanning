...
Die Implementierung erfolgt analog zu den in \ref{sec:smtcardinality} präsentierten Kodierungen und ist im Anhang \ref{appendix:cardinalityimpl} zu finden.
...
Deren Implementierung ist im Anhang \ref{appendix:incrementalrefinementimpl} zu finden.
Wie dort in Listing \ref{listing:incrementalrefinement} zu erkennen ist, wurde außerdem eine Schrittweite für das Anpassen der verfeinerten Schranken hinzugefügt.
