...
Für jede Eingabe an Bauteilen existiert eine Lösung, bei welcher alle Bauteile verplant werden.
Der Beweis dafür ist Hausaufgabe für den Leser. % TODO: Naja, bestenfalls schreib ich den hier noch hin!
Diese Optimierung ist mit Constraint \ref{constraint:eoLayer} bereits im Modell festgehalten.
