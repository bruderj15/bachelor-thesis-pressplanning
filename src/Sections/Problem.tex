        ...
        \text{Folgend die Signatur } \Sigma = \left( \Sigma_{F}^{P} \cup \Sigma_{F}^{L} \cup \Sigma_{F}^{C}, \Sigma_{R} \right) \text{ mit Variablen } \mathbb{X} = \mathbb{X}^{P} \cup \mathbb{X}^{L} \cup \mathbb{X}^{C} \text{ wobei } \\[5pt]
            \begin{array}{ll}
                \begin{aligned}
                    \Sigma_{F}^{P} = \left\{
                    \begin{aligned}
                        & (id, & P \rightarrow \mathbb{Z}), \\
                        & (minLength, & P \rightarrow \mathbb{Z}), \\
                        & (maxLength, & P \rightarrow \mathbb{Z}), \\
                        & (length, & P \rightarrow \mathbb{Z}), \\
                        & (minHeight, & P \rightarrow \mathbb{Z}), \\
                        & (maxHeight, & P \rightarrow \mathbb{Z}), \\
                        & (height, & P \rightarrow \mathbb{Z}), \\
                ...
                \begin{aligned}
                    \Sigma_{F}^{L} = \left\{
                    \begin{aligned}
                        & (id, & L \rightarrow \mathbb{Z}), \\
                        & (length, & L \rightarrow \mathbb{Z}), \\
                        & (height, & L \rightarrow \mathbb{Z}), \\
                        & (waste, & L \rightarrow \mathbb{Z}), \\
                ...
                \begin{aligned}
                    \Sigma_{F}^{C} &= \left\{
                    \begin{aligned}
                        & (length, & C \rightarrow \mathbb{Z}), \\
                        & (height, & C \rightarrow \mathbb{Z})\; \\
                    \end{aligned} \right\} \\
                \end{aligned}
                &
                \begin{aligned}
